...
- [x] 2.2 Align plan generation merge logic to deterministic precedence for supported customization fields (base template < workflow customization).
...
- [x] 3.2 Add or update test coverage for protected-field customization attempts to verify enforced rejection/ignore behavior.

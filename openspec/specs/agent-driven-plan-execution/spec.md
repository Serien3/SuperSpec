...
Define the protocol-driven, agent-executed action flow for SuperSpec v0.2, including pull-based action retrieval, lease-safe reporting, and executor-specific payload contracts.

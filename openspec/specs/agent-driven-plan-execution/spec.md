...
Define the protocol-driven, agent-executed step flow for SuperSpec v1.2.0, including pull-based step retrieval, serial reporting, and executor-specific payload contracts.
## Requirements
